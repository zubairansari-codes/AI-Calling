...
import com.gasagency.dsc.service.AuthService;
...
@RestController
@RequestMapping("/auth")
@Tag(name = "Authentication", description = "Signup and login for gas agencies")
public class AuthController {
    ...
    @PostMapping("/signup")
    @Operation(summary = "Register a new gas agency")
